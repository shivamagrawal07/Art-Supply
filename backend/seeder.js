...
const listings = [
  // Paints
  { title: 'Winsor & Newton Oil Paints (Set of 10)', description: 'Hardly used, moving to acrylics. Perfect for professional canvas work.', category: 'Paints', condition: 'used', price: 45, images: ['https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?w=600&h=400&fit=crop'] },
  { title: 'Heavy Body Golden Acrylics', description: 'Titanium white and Ultramarine blue almost full tubes.', category: 'Paints', condition: 'used', price: 22, images: ['https://images.unsplash.com/photo-1543857778-c4a1a3e0b2eb?w=600&h=400&fit=crop'] },
  { title: 'Holbein Gouache Set 24 Colors', description: 'Vibrant gouache set. Only opened once to swatch colors.', category: 'Paints', condition: 'new', price: 60, images: ['https://images.unsplash.com/photo-1599839619722-39751411ea63?w=600&h=400&fit=crop'] },
